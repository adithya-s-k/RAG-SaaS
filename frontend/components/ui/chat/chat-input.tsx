...
//     <form
//       onSubmit={onSubmit}
//       className="rounded-lg bg-slate-50 p-4 shadow-md shadow-black/10 space-y-4 shrink-0 border-2 border-slate-500/10"
//     >
//       {imageUrl && (
...
//           className="w-[45px] h-[45px] rounded-xl bg-[#cf5cf3] hover:bg-[#9c45b6] border-2 flex items-center justify-center"
//         >
//           {/* <Image
//             className="relative"
...
//             priority
//           /> */}
//           <SendHorizontal width={30} height={30} />
//         </Button>
